...
<View style={styles.view_account}>
  <Text style={{fontWeight: '500', fontSize: wp('2.7%'),letterSpacing:wp('-0.1')}}>Account</Text>
</View>
...
<View style={styles.view_date}>
  <Text style={{fontWeight: '500', fontSize: wp('2.7%'),letterSpacing:wp('-0.1')}}>Before</Text>
</View>
<View style={styles.view_date}>
  <Text style={{fontWeight: '500', fontSize: wp('2.7%'),letterSpacing:wp('-0.1')}}>After</Text>
</View>
